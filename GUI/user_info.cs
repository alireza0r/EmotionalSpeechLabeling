...
namespace GUI
{
    public partial class user_info : Form
    {
        ...
        {
            string[] full_info = { txtname.Text.ToString().ToUpper(),
                                   txtlastname.Text.ToString().ToUpper(),
            ...
            frmInfo.save_database_path(txtbrrowse.Text.ToString());
        ...
        {
            return users_data.Contains(firstName.ToUpper() + "," + lastName.ToUpper());
        }
