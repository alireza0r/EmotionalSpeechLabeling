...
namespace GUI
{
    public partial class Form1 : Form
    {
        ...
        public string DatasetPath = Application.StartupPath + "\\" + "LocalDatabase";
        ...
        private void btnnext_Click(object sender, EventArgs e)
        {
            ...
            string weak = emotions.Item1; // weak and strong are same
            if (emotions.Item2 !="")
                weak = emotions.Item2;
        ...
        private void radiostrong_Click(object sender, EventArgs e)
        {
            ...
            //MessageBox.Show(strong.ToString());
        ...
        private string filename_function(bool Next)
        {
            ...
            string sound_path = DatasetPath + "\\" + filename;
            //MessageBox.Show(sound_path);
            return sound_path;
        }
        ...
        {
            if (reset_factory_flag == true)
            {

            }
            else if (change_flag)
            {
                DialogResult dialogResult = MessageBox.Show("Do you want to save files?", "Saving...", MessageBoxButtons.YesNo);
        ...
        private void there_arent_any_file()
        {
            MessageBox.Show("There aren't any .wav files!\n\rPlease change path.");
            btnplay.Enabled = false;
            btnstop.Enabled = false;
        ...
        private void aboutToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            txt += "Gmail: Z.sharifzadeh.j@gmail.com (is active for your reports)\n";
            txt += "Version: 2.1.0";
        ...
        private void allDataExpertToToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (change_flag)
            {
                DialogResult result = MessageBox.Show("You must save changes before converting to Excel file.\n\rDo you want to save and continue?", "could not be converted...",
            ...
            SaveFileDialog dlog = new SaveFileDialog();
            dlog.Filter = "Excel files |*.xlsx|Excel files |*.xls";
        ...
        {
            //saving_delay_form(3);
            Thread t = new Thread(saving_delay_form);
            t.Start();
        ...
        private void saving_delay_form()
        {
            //int delay = 3;
        ...
        void write_dataset_path(string path, string userName)
        {
            ...
            stFile.AppendLine(userName + "," + DatasetPath);
